<script>
    ...
    let benefits = [
        ...
        {
            name: "a product designer & UX finatic",
...
<main class="flex flex-col flex-1 p-4">
    <section id="introPage" class="grid grid-cols-1 lg:gap-10 py-8 sm:py-14">
        <div class="flex flex-col lg:justify-center text-center lg:text-left gap-6 md:gap-8 lg:gap-10">
            <h2 class="font-semibold text-2xl sm:text-5xl md:text-6xl">
                Hi! I'm <span class="poppins text-violet-400">Samuel</span> Zápotocký <br/> Front End
    ...
    <section id="projects" class="py-20 lg:py-32 flex flex-col gap-24">
        ...
        <a
            href="https://github.com/zapotocky77"
            target="_blank"
    ...
    <section id="about" class="py-20 pt-10 lg:pt-16 lg:py-32 flex flex-col gap-16 sm:gap-20 md:gap-24 relative">
        ...
        <div class="flex flex-col overflow-x-scroll gap-10 max-w-[800px] mx-auto w-full">
            <table class="bg-white text-slate-700 rounded-lg text-center">
                <thead class="border-b border-solid border-slate-200">
                    <tr class="">
                        ...
                        <th class="whitespace-nowrap bg-violet-700 text-white rounded-tr-lg p-4 px-8">Me</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr class="border-b border-solid border-slate-200 border-b-0">
                        <td class="border-r border-solid border-white pl-4 pr-8 py-4 font-semibold text-sm whitespace-nowrap">
                            Programming Ability
                        </td>
                        <td><i class="fa-solid fa-check text-slate-500"></i></td>
